...
//        let sortedCoins = sortCoins(sort: sort, coins: coins)
        return updatedCoins
    }
...
//            }
    ...
    private func sortPortfolioCoinsIfNeeded(coins:[CoinModel]) -> [CoinModel] {
        // will only sort by holdings / reversedHoldings if needed
        switch sortOption {
        case .holdings:
...
//        }
        ...
        let previousValue =
            ...
            .map { coin -> Double in
                ...
                // priceChangedPercentage24H is returned in whole number, 25% = 25. /100 to get %
